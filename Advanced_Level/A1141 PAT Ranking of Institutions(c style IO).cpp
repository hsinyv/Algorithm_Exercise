...
*  No.A1141 PAT Ranking of Institutions(c style IO)
*  Date: 2021/02/25
***********************************************/
/***********************************************
...
int main(void) {
	...
	for (auto institute : all_institutes) {
		printf("%d %s %d %d\n", institute.rank_, institute.school_.c_str(), institute.total_weighted_score_, institute.num_testees);
	}
